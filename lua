...
local main = create('Frame',{['Name'] = 'Main',['Parent'] = screenGui,['Size'] = UDim2.new(0,200,0,24),['BackgroundColor3'] = Color3.fromRGB(46,46,46),['BorderSizePixel'] = 4, ['BorderColor3'] = Color3.fromRGB(64,64,64),['AnchorPoint'] = Vector2.new(0,0),['Position'] = UDim2.new(0.1,0,0,30)})
